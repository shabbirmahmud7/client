...
const CreationItem = ({item}) => {
  ...
  return (
    <div onClick={()=> setExpanded(!expended)} className='p-4 max-w-5xl text-sm bg-white border border-gray-200 rounded-lg cursor-pointer'>
            ...
            expended && (
                ...
                <div>
                    {item.type === 'image' ? (
                        ...
                        <div className='mt-3 h-full overflow-y-scrool text-sm text-state-700'>
